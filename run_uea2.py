...
def main(args):
    ...
    if data_args.create_file:
        with open(f"results/classification_acc.csv", 'w', newline='') as f:
            writer = csv.writer(f)
            writer.writerow(['Dataset', 'Accuracy'])  # optional header
    with open(f"results/classification_acc.csv", 'a', newline='') as f:
        writer = csv.writer(f)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--name', type=str, required=True, help='The dataset name in UEA')
    parser.add_argument('--create_file', type=bool, default=False, help='Whether to create a new result file')
