...
from datautils import load_ptb_xl
...
def parse_args():
    ...
    parser.add_argument('--dataset_name', type=str, default="PTB-XL/form", help='Name of the dataset (e.g. "PTB-XL/form", "PTB-XL/diagnostic", "PTB-XL/rhythm")')
    ...
    parser.add_argument('--output_dir', type=str, default='training/', help='Directory to save results')
    ...
    parser.add_argument('--weight_global_vatiant_contrast', type=float, default=0.,
                        help='Weight for the global variant contrastive loss')
    parser.add_argument('--weight_dynamic_trend_pred', type=float, default=0.1,
...
def main(args):
    ...
    train_data, train_labels, test_data, test_labels, val_data, val_labels = load_ptb_xl(args.dataset_name, s3_bucket="sagemaker-bdrl-aws", s3_prefix="xiaowang/HDST")
    ...
    run_dir = args.output_dir + args.dataset_name + '__' + name_with_datetime(args.run_name)
