...
if __name__ == '__main__':
    ...
    parser.add_argument('--dist_type', type=str, default='mcc')
    parser.add_argument('--gpu', type=int, default=0, help='The gpu no. used for training and inference (defaults to 0)')
    parser.add_argument('--batch-size', type=int, default=8, help='The batch size (defaults to 8)')
    parser.add_argument('--lr', type=float, default=0.001, help='The learning rate (defaults to 0.001)')
    parser.add_argument('--static-repr-dims', type=int, default=128, help='The static representation dimension (defaults to 128)')
    parser.add_argument('--dynamic-repr-dims', type=int, default=128, help='The dynamic representation dimension (defaults to 128)')
    ...
    parser.add_argument('--window_size', type=str, default="Auto", help='Window size (int, list, or "Auto")')
